...
I was in a sprint planning meeting last week. An hour and a half. Eight engineers, a product manager, and a scrum master on a Zoom call, cameras mostly off, estimating story points for work that hadn't started yet.

Fifteen minutes in, we got to a ticket I'd been thinking about. "Refactor the notification service to support batched delivery." The PM read the acceptance criteria. The scrum master asked for estimates. Someone said five points. Someone else said eight. A brief debate about whether the database migration counted as part of this ticket or should be broken out. The scrum master pulled up the Fibonacci reference card. We settled on eight.

I had already built it.

Not the whole thing. But I'd spent forty minutes the night before talking through the approach with an agent, refining a plan, and letting it generate a working prototype. The core logic was done. The migration was written. I'd reviewed the output and it was solid. What remained was integration testing and a PR. Maybe two hours of work.

I sat through the next seventy-five minutes of that meeting knowing the estimate was meaningless, the discussion was theater, and the Jira board we were so carefully grooming would be outdated before the sprint started. I alt-tabbed and kept working.

That meeting cost the company roughly two thousand dollars in engineering salaries. It produced a set of story point estimates that bore no relationship to how long the work would actually take, organized in a tool that nobody on the team uses as their actual source of truth. But the dashboard looked great. Somebody's OKR was being served.

This is the moment I'm writing about. Not the big existential question of AI replacing engineers. The smaller, more immediate, more fixable problem: the processes we use to organize engineering work are designed for a world that no longer exists, and every day we keep performing them is a day we're slower than we need to be.
